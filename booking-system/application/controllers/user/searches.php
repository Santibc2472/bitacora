 ...
 * File                    : application/controllers/user/searches.php
 * Author                  : Dot on Paper
 * Copyright               : © 2017 Dot on Paper
 * Website                 : https://www.dotonpaper.net
 * Description             : User searches controller PHP class.
 */

    if (!class_exists('DOTControllerUserSearches')){
        class DOTControllerUserSearches{
            /*
             * Constructor
	     * 
	     * @usage
