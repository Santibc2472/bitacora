 ...
 * File                    : application/controllers/user/extras.php
 * Author                  : Dot on Paper
 * Copyright               : © 2017 Dot on Paper
 * Website                 : https://www.dotonpaper.net
 * Description             : User extras controller PHP class.
 */

    if (!class_exists('DOTControllerUserExtras')){
        class DOTControllerUserExtras{
            /*
             * Constructor
	     * 
	     * @usage
