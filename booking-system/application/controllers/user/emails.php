 ...
 * File                    : application/controllers/user/emails.php
 * Author                  : Dot on Paper
 * Copyright               : © 2017 Dot on Paper
 * Website                 : https://www.dotonpaper.net
 * Description             : User emails controller PHP class.
 */

    if (!class_exists('DOTControllerUserEmails')){
        class DOTControllerUserEmails{
            /*
             * Constructor
	     * 
	     * @usage
