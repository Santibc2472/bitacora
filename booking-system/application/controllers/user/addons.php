 ...
 * File                    : application/controllers/user/addons.php
 * Author                  : Dot on Paper
 * Copyright               : © 2017 Dot on Paper
 * Website                 : https://www.dotonpaper.net
 * Description             : User add-ons controller PHP class.
 */

    if (!class_exists('DOTControllerUserAddons')){
        class DOTControllerUserAddons{
            /*
             * Constructor
	     * 
	     * @usage
