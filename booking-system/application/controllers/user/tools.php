 ...
 * File                    : application/controllers/user/tools.php
 * Author                  : Dot on Paper
 * Copyright               : © 2017 Dot on Paper
 * Website                 : https://www.dotonpaper.net
 * Description             : User tools controller PHP class.
 */

    if (!class_exists('DOTControllerUserTools')){
        class DOTControllerUserTools{
            /*
             * Constructor
	     * 
	     * @usage
