 ...
 * File                    : application/controllers/user/rules.php
 * Author                  : Dot on Paper
 * Copyright               : © 2017 Dot on Paper
 * Website                 : https://www.dotonpaper.net
 * Description             : User rules controller PHP class.
 */

    if (!class_exists('DOTControllerUserRules')){
        class DOTControllerUserRules{
            /*
             * Constructor
	     * 
	     * @usage
