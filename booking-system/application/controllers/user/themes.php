 ...
 * File                    : application/controllers/user/themes.php
 * Author                  : Dot on Paper
 * Copyright               : © 2017 Dot on Paper
 * Website                 : https://www.dotonpaper.net
 * Description             : User themes controller PHP class.
 */

    if (!class_exists('DOTControllerUserThemes')){
        class DOTControllerUserThemes{
            /*
             * Constructor
	     * 
	     * @usage
