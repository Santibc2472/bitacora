 ...
 * File                    : application/controllers/user/coupons.php
 * Author                  : Dot on Paper
 * Copyright               : © 2017 Dot on Paper
 * Website                 : https://www.dotonpaper.net
 * Description             : User coupons controller PHP class.
 */

    if (!class_exists('DOTControllerUserCoupons')){
        class DOTControllerUserCoupons{
            /*
             * Constructor
	     * 
	     * @usage
