 ...
 * File                    : application/controllers/user/discounts.php
 * Author                  : Dot on Paper
 * Copyright               : © 2017 Dot on Paper
 * Website                 : https://www.dotonpaper.net
 * Description             : User discounts controller PHP class.
 */

    if (!class_exists('DOTControllerUserDiscounts')){
        class DOTControllerUserDiscounts{
            /*
             * Constructor
	     * 
	     * @usage
