 ...
 * File                    : application/controllers/user/forms.php
 * Author                  : Dot on Paper
 * Copyright               : © 2017 Dot on Paper
 * Website                 : https://www.dotonpaper.net
 * Description             : User forms controller PHP class.
 */

    if (!class_exists('DOTControllerUserForms')){
        class DOTControllerUserForms{
            /*
             * Constructor
	     * 
	     * @usage
